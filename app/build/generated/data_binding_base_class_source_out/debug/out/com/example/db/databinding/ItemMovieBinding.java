...
public final class ItemMovieBinding implements ViewBinding {
  ...
  private ItemMovieBinding(@NonNull MaterialCardView rootView, @NonNull CheckBox fav,
      @NonNull ImageView image, @NonNull TextView title, @NonNull TextView year) {
  ...
  public static ItemMovieBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.fav;
      CheckBox fav = ViewBindings.findChildViewById(rootView, id);
      if (fav == null) {
        break missingId;
      }
      ...
      return new ItemMovieBinding((MaterialCardView) rootView, fav, image, title, year);
    }
